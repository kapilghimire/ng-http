...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        this.dataService.getAllBooks()
            .subscribe((data) => this.allBooks = data, (error) => console.log(error), () => console.log('All done getting books. '));
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getBookById(bookID).subscribe((book) => this.selectedBook = book, (error) => console.log(error), () => console.log(`complete`));
    }
    setMostPopular() {
    ...
    saveChanges() {
        this.dataService.updateBook(this.selectedBook)
            .subscribe((data) => console.log(`${this.selectedBook.title} updated successfully.`), (err) => console.log);
    }
};
